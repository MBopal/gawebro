    ...
    <section id="details"
        ...
        <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px]">
            ...
            <div class="flex flex-col gap-[6px] w-full">
                ...
                <p class="text-sm leading-[28px]">I'm seeking a proficient developer to create a unique opinion
                    collection app without a user registration feature. The primary aim of this app will be to collect
                    user opinions on specific topics while maintaining the anonymity of the users. The interface should
                    be user-friendly and intuitive to encourage consistent engagement. The ideal freelancer for this
                    project would have a strong background in mobile app development with particular experience in
                    creating apps that revolve around anonymity and user-generated content. A good understanding of user
                    interface design would be appreciated. Your input on ways to enhance the user experience will be
                    vital, so I value effective communication skills.</p>
            </div>
            <div class="flex flex-col gap-[6px] w-full">
